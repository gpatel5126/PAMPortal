<?php
	...
	if ($i != 0 && ($j != 0 || $accounts != 0)) {
		...
		if ($j == 0) { $uncompliant_accounts_data = '0,0'; $a_starting_date = 'No servers'; $a_ending_date = ''; }
	...
	<div id="mydash">
		...
		<div id="scorecards">
			...
			<div class="grey last">
				...
				<a href="#" class="num"><span>6</span>Access Requests</a>
				<a href="#" class="num"><span>12</span>Safe Creation Requests</a>
			</div>
		</div>
