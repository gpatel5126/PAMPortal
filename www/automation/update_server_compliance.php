<?php
	...
	if ($results > 0) {
		$mysqli->real_query("
			DELETE FROM server_user_compliance_history WHERE date = '2014-08-05'
		");
	}
	...
	$mysqli->real_query("
		SELECT t1.uid
		FROM (SELECT * FROM server_user_compliance_history WHERE date = '2014-07-29') t1
		LEFT JOIN (SELECT * FROM server_user_compliance_history WHERE date = '2014-08-05') t2 ON (t1.UID = t2.UID)
