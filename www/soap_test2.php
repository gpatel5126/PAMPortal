...
$soap = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"> 
   ...
   <soapenv:Body> 
      <ns1:executeProcess xmlns:ns1="http://bmc.com/ao/xsd/2008/09/soa"> 
         ...
         <ns1:processName>:CyberArk_MyWorkTest:CreateSafeRequest</ns1:processName> 
         <ns1:parameters> 
            <ns1:Input> 
               <ns1:Parameter> 
                  ...
                  <ns1:Value> 
                     <ns1:XmlDoc> 
                        <input> 
                           <safename>steves_test_safe9edf</safename> 
                           <owners>steveadmin</owners> 
                           <members></members> 
                           <site>sjc</site> 
                           <description>test desc for a new safe</description> 
                        </input> 
                     </ns1:XmlDoc> 
                  </ns1:Value> 
               </ns1:Parameter> 
