...
<aside id="sidebar">
	...
	<nav>
		...
		<ul>
			...
			<li><a href="create_account.php" class="active"><b></b><i class="fa fa-briefcase"></i>Add/Manage Objects</a></li>
	...
	<div id="mydash">
		<div class="accounts cf">
			...
			<div id="object">
				...
				<a href="#" id="move_button" class="object_actions"><i class="fa fa-arrows"></i>Move this object</a><a href="#" id="delete_button" class="object_actions"><i class="fa fa-times"></i>Delete this object</a>
			</div>
			<div id="inventory">
				<div class="shader">
			...
			<div id="inst">
				...
				<div id="objectSearch">
					<input type="text" name="objectSearchQuery" value="search individual objects..." class="inactive" />
					<div class="filters">
						<label>Search by:</label><a href="#" class="active first">Object</a><a href="#">Account</a><a href="#" class="last">Server/host</a>
					</div>
					<ul id="searchResults">
