			...
			$.ajax({
			   ...
			   success: function(data)
			   {
					if ( data.status == 'Success') {
						$("#formLoading").html("<i class='fa fa-check-circle'></i><br />Your account has been protected!<span>Object created with name '"+data.objectName+"'</span><a href='#' class='formReset fButton' id='back_after_create'><i class='fa fa-chevron-circle-left'></i>Back to My Domain Accounts!</a>");
					}
...
<aside id="sidebar">
	...
	<nav>
		...
		<ul>
			...
			<li><a href="my_accounts.php"class="active"><b></b><i class="fa fa-user"></i>My Domain Accounts</a></li>
		</ul>
...
<h1 id="main"><i class="fa fa-user"></i>My Domain Accounts
<?php if ($priv) { ?>
